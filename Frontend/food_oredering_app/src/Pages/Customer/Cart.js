...
const Cart=()=>{
  ...
  <section className="h-100 bg-dark" class="myStyle">
    ...
    <td>{cart.selectedMenu.price * cart.quantity}</td>   
        ...
        <button type="button" class="btn btn-info btn-sm" style={ {marginLeft:240,marginTop:50}}>proceed</button>
        </Link>
        <Link to="/CustomerHomePage">
        <button type="button" class="btn btn-danger btn-sm" style={ {marginLeft:250,marginTop:10}}>Back</button>
        </Link>
