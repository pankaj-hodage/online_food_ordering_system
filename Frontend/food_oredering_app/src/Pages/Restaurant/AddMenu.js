...
const AddMenu=()=>{
    ...
    <h3 className="mb-5 text-uppercase" style={ {textAlign:'center'}}>MENU </h3>
                ...
                <div className="form-outline mb-4" >
                  <label  className="form-label" for="form3Example97">Category &nbsp;&nbsp;</label>
                ...
                <div className="form-outline mb-4" >
                  <label  className="form-label" for="form3Example97" 
                    >image</label>
                    <input type="file" id="form3Example97" className="form-control form-control-lg" 
                     onChange={(e)=>{
                        setFile(e.target.files[0])
                    }} />  
                </div>

                <button onClick={addNewMenu} type="submit" className="btn btn-success "style={{marginLeft:220}}>Submit</button>
