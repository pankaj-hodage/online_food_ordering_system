  ...
  <a className="navbar-brand" href="/deliveryBoyHome"><b style={{color:'#F7BC0F', fontSize:30}}>Foodie</b></a>
    ...
    <div id="navbarSupportedContent" class="collapse navbar-collapse">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active"><a href="/acceptedOrder" class="nav-link active">My Orders</a></li>
       
      <div class="mybtn-right" style={{marginLeft:700}}>
        <Link className="nav-link" className="btn btn-danger" style={{backgroundColor:'#5C41A8'}} to="/signin">Logout</Link>
      </div>
